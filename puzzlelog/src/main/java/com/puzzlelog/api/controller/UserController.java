...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Page<UserResponse>>> getUsers(
        ...
        if (request.hasNoCondition()) {
            ...
            return ResponseEntity.ok(ApiResponse.success(users, "전체 사용자 조회 성공"));
        }
        ...
        return ResponseEntity.ok(ApiResponse.success(users, "사용자 정보 조회 성공"));
    }
