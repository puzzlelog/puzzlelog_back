...
//✅ 사용자가 챌린지를 취소할 때 호출하는 Command
public class CancelUserChallengeService implements Command<Void> {
 private final UserChallengeRepository userChallengeRepository;
 private final String userId;
 private final String challengeId;

 public CancelUserChallengeService(UserChallengeRepository userChallengeRepository, String userId, String challengeId) {
